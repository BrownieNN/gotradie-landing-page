...
export default function InstagramButton(props) {
...
const Wrapper = styled.div`
  cursor: pointer;
  background: rgb(85,109,233);
background: linear-gradient(45deg, rgba(85,109,233,1) 0%, rgba(85,109,233,1) 43%, rgba(251,52,55,1) 100%);
